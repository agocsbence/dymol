...
if ( $product->is_in_stock() ) : ?>
	...
	<div>
		...
		<form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
			...
			<div class="quantity-wrapper flex flex-row-center">
				<?php
			...
			<div class="text-right">
				<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button button alt btn btn-dark"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
			</div>
